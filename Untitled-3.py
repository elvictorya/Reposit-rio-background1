...
if __name__ == "__main__":
    input_file = "/home/ellen/Downloads/MG5_aMC_v3_7_1/bin/background2/Events/run_01/tag_1_delphes_events.root"
    tree_name  = "Delphes"
    ...
    # cria arquivo texto
    with open("cutflow(background2).txt", "w") as f:
    ...
    print("\nTabela salva em: cutflow(background2).txt")
